# !/usr/bin/bash
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# Script:~/crisprome/human_temporal_metagenome_wangjun_2022natComm/scripts/22.genomad.sh 
...
OUTPUT_DIR=${BASE}/intermediates/23.genomad/without_nn
mkdir -p ${OUTPUT_DIR}
...
do
	...
	#genomad end-to-end --cleanup --splits 4 --threads 4 ${input} ${output} ~/software/genomad/genomad_db
done
conda deactivate
